            ...
            tryHookAllMethods(InCallControllerClass, "onCallStateChanged", new XC_MethodHook() {
                ...
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    try {
                        ...
                        if (vibrateOnAnswered && oldState == 3 /* Dialing */ && newState == 5 /* ACTIVE */ && SystemClock.uptimeMillis() - lastActiveVibration > 5000L /* Don't vibrate on concurrent method calls */) {
                            lastActiveVibration = SystemClock.uptimeMillis();
                            SystemUtils.vibrate(vibrationEffect, VibrationAttributes.USAGE_NOTIFICATION);
                        } else if (vibrateOnDrop && oldState == 5 /* ACTIVE */ && newState == 7 /* DISCONNECTED */ && SystemClock.uptimeMillis() - lastDropVibration > 5000L) {
